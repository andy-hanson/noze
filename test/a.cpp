...
_void call_with_ctx___void__ptr_ctx_arg1_is_4(ctx* c);
...
_void print_range___void_arg0_is_6_arg1_is_8_arg2_is_3(ctx* ctx);
arr__char to_str__arr__char__nat64(ctx* ctx, nat64 n);
_void print_range___void_arg0_is_7_arg1_is_8_arg2_is_3(ctx* ctx);
...
int64 main__int64() {
	...
	call_with_ctx___void__ptr_ctx_arg1_is_4(ctx_by_ptr);
	return 0;
}
_void call_with_ctx___void__ptr_ctx_arg1_is_4(ctx* c) {
...
_void print_range___void_arg0_is_5_arg1_is_8_arg2_is_3(ctx* ctx) {
	...
	return print_range___void_arg0_is_6_arg1_is_8_arg2_is_3(ctx);
}
_void other_main___void__lambda0(ctx* ctx, nat64 x) {
...
_void print_range___void_arg0_is_6_arg1_is_8_arg2_is_3(ctx* ctx) {
	...
	return print_range___void_arg0_is_7_arg1_is_8_arg2_is_3(ctx);
}
arr__char to_str__arr__char__nat64(ctx* ctx, nat64 n) {
