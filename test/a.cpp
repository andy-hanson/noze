...
struct filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure;
struct comparison;
struct less {};
struct greater {};
struct equal {};
...
struct filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure;
...
static_assert(sizeof(filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure) == 16, "");
...
static_assert(sizeof(filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure) == 16, "");
...
static arr__char _constantArr4666133 = arr__char{6, const_cast<char*>("%.*s\n\0")};
static arr__char _constantArr4666120 = arr__char{1, const_cast<char*>("0")};
static arr__char _constantArr4666121 = arr__char{1, const_cast<char*>("1")};
static arr__char _constantArr4666123 = arr__char{1, const_cast<char*>("2")};
static arr__char _constantArr4666122 = arr__char{1, const_cast<char*>("3")};
static arr__char _constantArr4666127 = arr__char{1, const_cast<char*>("4")};
static arr__char _constantArr4666126 = arr__char{1, const_cast<char*>("5")};
static arr__char _constantArr4666129 = arr__char{1, const_cast<char*>("6")};
static arr__char _constantArr4666130 = arr__char{1, const_cast<char*>("7")};
static arr__char _constantArr4666131 = arr__char{1, const_cast<char*>("8")};
static arr__char _constantArr4666132 = arr__char{1, const_cast<char*>("9")};
...
_void call_with_ctx___void__ptr_ctx_arg1_is_4215953(ctx* c);
...
stream__nat64 as__stream__nat64__stream__nat64(stream__nat64 value);
stream__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952(ctx* ctx, stream__nat64 in);
...
iterator__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic(ctx* ctx, filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure* _closure);
...
_void fail___void_arg0_is_4666124(ctx* ctx);
...
opt__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0__dynamic(ctx* ctx, filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure* _closure);
...
_void each___void__range_nat64__cat__arr__char__arr__char__arr__char__lambda0___closure__iter_klb1_is_cat__arr__char__arr__char__arr__char__lambda0(ctx* ctx, range_nat64 r, cat__arr__char__arr__char__arr__char__lambda0___closure f);
range_nat64 to__range_nat64__nat64__nat64(ctx* ctx, nat64 lo, nat64 hi);
_void each___void__range_nat64__cat__arr__char__arr__char__arr__char__lambda1___closure__iter_klb1_is_cat__arr__char__arr__char__arr__char__lambda1(ctx* ctx, range_nat64 r, cat__arr__char__arr__char__arr__char__lambda1___closure f);
...
opt__nat64 filter_helper__opt__nat64__iterator__nat64_arg1_is_4215952(ctx* ctx, iterator__nat64 i);
...
_void hard_fail___void_arg0_is_4666125();
...
int64 main__int64() {
	...
	call_with_ctx___void__ptr_ctx_arg1_is_4215953(ctx_by_ptr);
	return 0;
}
_void call_with_ctx___void__ptr_ctx_arg1_is_4215953(ctx* c) {
...
_void other_main___void(ctx* ctx) {
	...
	stream__nat64 filtered = filter__stream__nat64__stream__nat64_arg1_is_4215952(ctx, rgs);
...
stream__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952(ctx* ctx, stream__nat64 in) {
	return stream__nat64{fun0__iterator__nat64{
		reinterpret_cast<fun_ptr2__iterator__nat64__ptr_ctx__ptr__byte>(filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic), reinterpret_cast<ptr__byte>(_alloc<filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure>(allocate_bytes__ptr__byte__nat64(ctx, 16), filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure{in}))}};
}
nat64 sum__nat64__stream__nat64__iter(ctx* ctx, stream__nat64 t) {
...
_void assert___void__bool(ctx* ctx, bool condition) {
	if (condition) {
		...
		return fail___void_arg0_is_4666124(ctx);
	}
}
bool equalequal__bool__nat64__nat64(nat64 a, nat64 b) {
...
iterator__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic(ctx* ctx, filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0___closure* _closure) {
	...
	return iterator__nat64{fun0__opt__nat64{
		reinterpret_cast<fun_ptr2__opt__nat64__ptr_ctx__ptr__byte>(filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0__dynamic), reinterpret_cast<ptr__byte>(_alloc<filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure>(allocate_bytes__ptr__byte__nat64(ctx, 16), filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure{itr}))}};
}
nat64 sum_helper__nat64__iterator__nat64(ctx* ctx, iterator__nat64 i) {
...
arr__char cat__arr__char__arr__char__arr__char(ctx* ctx, arr__char a, arr__char b) {
	...
	each___void__range_nat64__cat__arr__char__arr__char__arr__char__lambda0___closure__iter_klb1_is_cat__arr__char__arr__char__arr__char__lambda0(ctx, to__range_nat64__nat64__nat64(ctx, 0, a.size), cat__arr__char__arr__char__arr__char__lambda0___closure{m, a});
	each___void__range_nat64__cat__arr__char__arr__char__arr__char__lambda1___closure__iter_klb1_is_cat__arr__char__arr__char__arr__char__lambda1(ctx, to__range_nat64__nat64__nat64(ctx, 0, b.size), cat__arr__char__arr__char__arr__char__lambda1___closure{m, a, b});
...
opt__nat64 filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0__dynamic(ctx* ctx, filter__stream__nat64__stream__nat64_arg1_is_4215952__lambda0__dynamic__lambda0___closure* _closure) {
	return filter_helper__opt__nat64__iterator__nat64_arg1_is_4215952(ctx, _closure->itr);
}
opt__nat64 next__opt__nat64__iterator__nat64(ctx* ctx, iterator__nat64 i) {
...
_void todo___void() {
	return hard_fail___void_arg0_is_4666125();
}
_void forbid___void__bool(ctx* ctx, bool condition) {
	...
	switch (matched.kind) {
		...
		case opt__nat64::Kind::some__nat64: {
			...
			if (other_main___void__lambda0(ctx, v)) {
				...
				return filter_helper__opt__nat64__iterator__nat64_arg1_is_4215952(ctx, i);
			}
		}
		default: assert(0);
	}
